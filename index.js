...
client.on("guildMemberAdd", async (member) => {
  ...
  welcomemsg('803083110295535626', '803082302795808769', client, member)
})
...
const mongoose = require("mongoose");
  ...
  try {
    if(!await pdb.User.findOne({userID: message.author.id})) {
      await pdb.User.create({userID: message.author.id})
